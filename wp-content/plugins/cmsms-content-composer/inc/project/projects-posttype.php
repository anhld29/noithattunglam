...
class Cmsms_Projects {
	public function __construct() {
		...
		$portfolio_pj_categs_slug = ((isset($portfolio_project_settings_array[$current_theme . '_portfolio_pj_categs_slug']) && $portfolio_project_settings_array[$current_theme . '_portfolio_pj_categs_slug'] != '') ? $portfolio_project_settings_array[$current_theme . '_portfolio_pj_categs_slug'] : 'pj-categs');
		
		$portfolio_pj_tags_slug = ((isset($portfolio_project_settings_array[$current_theme . '_portfolio_pj_tags_slug']) && $portfolio_project_settings_array[$current_theme . '_portfolio_pj_tags_slug'] != '') ? $portfolio_project_settings_array[$current_theme . '_portfolio_pj_tags_slug'] : 'pj-tags');
		...
		$pj_categs_labels = apply_filters('cmsms_pj_categs_labels_filter', array( 
			'name' => 					__('Project Categories', 'cmsms_content_composer'), 
			'singular_name' => 			__('Project Category', 'cmsms_content_composer') 
		) );
		...
		$pj_tags_labels = apply_filters('cmsms_pj_tags_labels_filter', array( 
			'name' => 					__('Project Tags', 'cmsms_content_composer'), 
			'singular_name' => 			__('Project Tag', 'cmsms_content_composer') 
		) );
