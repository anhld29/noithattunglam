	...
	cmsms_sidebar : { 
		...
		fields : { 
			...
			sidebar : { 
				type : 		'select', 
				title : 	cmsms_shortcodes.sidebar_title, 
				descr : 	cmsms_shortcodes.sidebar_field_sidebar_descr + "<br /><span>" + cmsms_shortcodes.note + ' ' + cmsms_shortcodes.sidebar_field_sidebar_descr_note + '<a href=\"' + cmsms_shortcodes.admin_url + 'admin.php?page=cmsms-settings-element&tab=sidebar" target=\"_blank\">' + ' ' + cmsms_shortcodes.sidebar_field_sidebar_descr_note_link + "</a></span>", 
				def : 		'', 
				required : 	true, 
				width : 	'half', 
