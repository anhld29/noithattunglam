 ...
 */
!function(t){t.fn.cmsmsResponsiveNav=function(s){var e={submenu:"ul.sub-menu",respButton:".responsive_nav",startWidth:1024},n=this,i={},i={init:function(){i.o=t.extend({},e,s),i.el=n,i.v={},i.v.pLinkText="",i.setVars(),i.restartNav()},setVars:function(){i.v.submenu=i.el.find(i.o.submenu),i.v.subLink=i.v.submenu.closest("li").find("> a"),i.v.respButton=t(i.o.respButton),i.v.startWidth=i.o.startWidth,i.v.win=t(window),i.v.trigger=!1,i.v.counter=0,i.startEvent()},buildNav:function(){i.v.trigger=!0,i.v.counter=1,i.v.subLink.each(function(){""===t(this).text()&&(i.v.pLinkText=t(this).closest("ul").closest("li").find("> a").text(),t(this).addClass("cmsms-resp-nav-custom-text").text(i.v.counter+". "+i.v.pLinkText),i.v.counter+=1)}),i.v.submenu.hide()},restartNav:function(){!i.v.trigger&&cmsmasters_media_width()<=i.v.startWidth?i.buildNav():i.v.trigger&&cmsmasters_media_width()>i.v.startWidth&&i.destroyNav()},resetNav:function(){i.v.submenu.hide()},destroyNav:function(){i.v.subLink.each(function(){t(this).hasClass("cmsms-resp-nav-custom-text")&&t(this).removeClass("cmsms-resp-nav-custom-text").text("")}),i.v.submenu.css("display",""),i.v.trigger=!1},startEvent:function(){i.v.win.on("resize",function(){i.restartNav()})}};i.init()}}(jQuery);
/**!
...
*/
!function(e){e.fn.cmsmsFixedHeaderScroll=function(i){var t={headerTop:".header_top",headerMid:".header_mid",headerBot:".header_side",navBlock:"nav",navList:"#navigation",navTopList:"#top_line_nav",respNavButton:".responsive_nav",respTopNavButton:".responsive_top_nav",fixedClass:".fixed_header",fixedClassBlock:"#page",respHideBlocks:"",maxWidthMid:1024,maxWidthBot:1024,changeTopHeight:!0,changeMidHeight:!0,mobileDisabled:!0},n=this,o={},o={init:function(){o.options=o.o=e.extend({},t,i),o.el=n,o.vars=o.v={},o.v.newTopHeight=0,o.v.newMidHeight=0,o.setHeaderVars(),o.startHeader()},setHeaderVars:function(){o.v.headerMidString=o.o.headerMid,o.v.headerTop=o.el.find("> "+o.o.headerTop),o.v.headerMid=o.el.find("> "+o.v.headerMidString),o.v.headerBot=o.el.find("> "+o.o.headerBot),o.v.respNavButton=o.el.find(o.o.respNavButton),o.v.respTopNavButton=o.el.find(o.o.respTopNavButton),o.v.respHideBlocks=e(o.o.respHideBlocks),o.v.navListString=o.o.navList,o.v.navTopListString=o.o.navTopList,o.v.navBlockString=o.o.navBlock,o.v.navBlock=o.el.find(o.v.navListString).parents(o.v.navBlockString),o.v.navTopBlock=o.el.find(o.v.navTopListString).parents(o.v.navBlockString),o.v.midChangeHeightBlocks=e(o.v.headerMidString+", "+o.v.headerMidString+" .header_mid_outer, "+o.v.headerMidString+" .resp_nav_wrap_inner, "+o.v.headerMidString+" .search_wrap_inner, "+o.v.headerMidString+" .slogan_wrap_inner, "+o.v.headerMidString+" .social_wrap_inner, "+o.v.headerMidString+" "+o.v.navListString+", "+o.v.headerMidString+" "+o.v.navListString+" > li, "+o.v.headerMidString+" "+o.v.navListString+" > li > a, "+o.v.headerMidString+" .logo"),o.v.midChangeHeightBlocksResp=e(o.v.headerMidString+", "+o.v.headerMidString+" .header_mid_outer, "+o.v.headerMidString+" "+o.v.navListString+", "+o.v.headerMidString+" "+o.v.navListString+" > li, "+o.v.headerMidString+" "+o.v.navListString+" > li > a"),o.v.topHeight=0,o.v.midHeight=o.v.headerMid.attr("data-height"),o.v.win=e(window),o.v.winScrollTop=o.v.win.scrollTop(),o.v.winMidScrollTop=o.v.winScrollTop-o.v.topHeight,o.v.isMobile="ontouchstart"in document.documentElement},startHeader:function(){0<o.v.headerTop.length&&(o.v.topHeight=o.v.headerTop.attr("data-height")),o.attachEvents(),o.v.win.trigger("scroll")},attachEvents:function(){o.v.respNavButton.bind("click",function(){return o.v.respNavButton.is(":not(.active)")?(o.v.navBlock.css({display:"block"}),o.v.respHideBlocks.css({display:"none"}),o.v.respNavButton.addClass("active")):(o.v.navBlock.css({display:"none"}),o.v.respHideBlocks.css({display:"block"}),o.v.respNavButton.removeClass("active")),!1}),o.v.respTopNavButton.bind("click",function(){return o.v.respTopNavButton.is(":not(.active)")?(o.v.navTopBlock.css({display:"block"}),o.v.respHideBlocks.css({display:"none"}),o.v.respTopNavButton.addClass("active")):(o.v.navTopBlock.css({display:"none"}),o.v.respHideBlocks.css({display:"block"}),o.v.respTopNavButton.removeClass("active")),!1}),o.v.win.bind("scroll",function(){return o.el.parents(o.o.fixedClassBlock).is(":not("+o.o.fixedClass+")")||o.o.mobileDisabled&&o.v.isMobile?!1:void(cmsmasters_media_width()>o.o.maxWidthMid&&o.getScrollTop())}),o.v.win.bind("resize",function(){0<o.v.headerBot.length?o.headerResize(o.o.maxWidthBot):o.headerResize(o.o.maxWidthMid)})},getScrollTop:function(){o.v.winScrollTop=o.v.win.scrollTop(),o.v.winMidScrollTop=o.v.winScrollTop-o.v.topHeight},headerResize:function(e){cmsmasters_media_width()>e?(o.v.navBlock.removeAttr("style"),o.v.respHideBlocks.removeAttr("style"),o.v.respNavButton.removeClass("active"),o.getScrollTop()):o.v.headerTop.removeAttr("style")}};o.init()}}(jQuery);
